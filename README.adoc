...
video::http://vimeo.com/ericschabell/bpmsuite-fuse-integraiton-demo-run[https://raw.githubusercontent.com/jbossdemocentral/brms-fuse-integration-demo/master/docs/demo-images/video-demo-run.png]
